...
public class ListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //viewHolder.txtVersion.setText("Version: "+numbers[position]);         //VERY IMPORTANT: ALL THE TEXTVIEWS WILL be made like this. They will each have a version: and then w/e text you want
